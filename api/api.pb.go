...
type Request struct {
	...
	Session     *Session   `protobuf:"bytes,3,opt,name=session,proto3" json:"session,omitempty"`                         // client not set
	Protocol    uint32     `protobuf:"varint,4,opt,name=protocol,proto3" json:"protocol,omitempty"`                      // client not set
	PayloadType uint32     `protobuf:"varint,5,opt,name=payloadType,proto3" json:"payloadType,omitempty"`                // client not set
	BinRequest  []byte     `protobuf:"bytes,6,opt,name=bin_request,json=binRequest,proto3" json:"bin_request,omitempty"` // client not set
...
type Reply struct {
	...
	BinReply []byte     `protobuf:"bytes,4,opt,name=bin_reply,json=binReply,proto3" json:"bin_reply,omitempty"`
}
